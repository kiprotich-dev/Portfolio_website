...
urlpatterns = [
    ...
    path('gallery_single/', my_views.gallery_single, name='gallery_single-url'),
    path('contact/', my_views.contact, name='contact-url'),
    path('services/', my_views.service, name='services-url'),
    path('starter/', my_views.starter, name='starter.url'),
]
